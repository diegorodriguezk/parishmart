    ...
    <>
      ...
      <Section id="featured" width="wide" className="!pt-2">
        ...
        <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-5">
          <BusinessCard photo="people" initials="MS" title="Maria's Studios" description="Photography for families, Emmaus retreats and parish events." tags={["Photography", "Weston, FL", "Supports Emmaus"]} offer="10% OFF" offerDescription="Family & event sessions" impactText="Supports Emmaus retreat memories and parish events." primaryCta="Book" />
          <BusinessCard photo="people" initials="CM" title="Casa Manresa" description="Retreats, spiritual formation and community experiences." tags={["Retreats", "Formation", "SKD Partner"]} offer="15% OFF" offerDescription="Selected retreat experiences" impactText="Supports faith formation and local retreat participation." primaryCta="Explore" />
