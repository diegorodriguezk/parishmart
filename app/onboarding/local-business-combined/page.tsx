...
export const metadata = {
  title: "Become a Local Business (Combined) · ParishMart",
};

const TRUST_CARDS = [
  {
    kicker: "Products & Services",
    title: "One profile, both worlds",
    body: "Sell products, offer services, or do both from a single business page.",
  },
  {
...
export default function CombinedBizOnboardingIntro() {
  return (
          ...
          <div className="grid gap-8 p-6 sm:p-8 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:gap-10 lg:p-10">
            ...
            <div className="flex flex-col gap-5">
              ...
              <h1 className="max-w-[540px] text-4xl font-extrabold leading-[1.05] tracking-tight text-pm-navy md:text-5xl">
                ...
                <span className="pm-gradient-text">products and services</span>.
              </h1>
              <p className="max-w-[520px] text-sm text-pm-muted md:text-base">
                A single guided flow that adapts to what you offer. The
                Concierge guides you naturally while the form stays visible,
            ...
            <div className="rounded-3xl border border-pm-border bg-white/90 p-5 shadow-pm-soft backdrop-blur sm:p-6">
              ...
              <p className="text-lg font-extrabold tracking-tight text-pm-navy">
                Hi, I&rsquo;ll help you set up your business.
              </p>
