...
const PLANS = [
  ...
  },
  {
    ...
    tag: "For parishes",
    features: [
      "Linked to parish page",
      "Multi-cause management",
      "Shared sponsor pool",
      "Priority placement",
    ],
  },
...
export default function CauseStep6() {
    ...
    >
      <div className="rounded-[28px] border border-pm-border bg-white/90 p-6 shadow-pm-card backdrop-blur sm:p-7">
        <div className="mb-6 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-pm-muted">
              Start with Community (free) to launch quickly. Upgrade to Cause
              Plus for analytics and unlimited campaigns at any time.
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 flex items-center justify-between gap-4 border-t border-pm-border pt-5">
          <Link href="/onboarding/cause/step-5" className="pm-btn pm-btn-secondary">
            Back
          </Link>
