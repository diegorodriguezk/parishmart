...
const PARISHSOFT_GIVE_URL =
  "https://giving.parishsoft.com/app/giving/stk2501240";

export async function GiveContent({
  breadcrumbs,
  heroKicker = "Saint Katharine Drexel · Weston, FL",
  heroTitle = "Support the ministries that bring SKD to life.",
  heroDescription = "Discover ministries, outreach programs and parish causes connected to the SKD community.",
  heroPhoto = "congregation",
  filterChips = [
    "All Causes",
    "Ministries",
    "Youth",
  ...
  sectionTitle = "Featured Causes",
  sectionDescription = "Simple, clean and emotional ministry cards with a single CTA.",
  causeHref = PARISHSOFT_GIVE_URL,
  submitCauseHref = "/onboarding/parish",
  darkPanelCtaHref = "/shop",
}: {
  breadcrumbs?: Crumb[];
  heroKicker?: string;
  ...
  return (
    <>
      ...
      <Section width="wide" className="!py-4">
        <FilterChips items={filterChips} active={filterChips[0]} />
      </Section>
