        ...
        <div className="flex-1 overflow-y-auto px-5 py-4">
          {cart.items.length === 0 && cart.donations.length === 0 ? (
            <div className="flex h-full flex-col items-center justify-center text-center">
              <span className="grid h-12 w-12 place-items-center rounded-full bg-pm-soft text-pm-blue">
                <ShoppingBag className="h-6 w-6" aria-hidden />
              </span>
              <p className="mt-3 text-sm font-bold text-pm-navy">
                Your cart is empty
              </p>
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="grid h-6 w-6 place-items-center text-pm-muted hover:text-pm-navy"
